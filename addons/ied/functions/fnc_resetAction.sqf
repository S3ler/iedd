...
private _variation = if (_useRandom) then {
    ...
    _bombObj getVariable [QGVAR(variation), _random];
};
...
[
    ...
    {
        params ["","_pos","_type","_variation","_dir","_vectorDirAndUp"];
        [QGVAR(training), [_type,_pos,_variation,_dir,_vectorDirAndUp]] call CBA_fnc_serverEvent;
    },
